      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6">
        ...
        <div className="relative z-10 mx-auto max-w-3xl text-center">
          <div className="mb-8 flex justify-center">
            <LogoIcon className="h-16 w-16" color="#f0f1ff" />
          </div>
          <h1 className="font-display text-5xl font-bold leading-[1.05] tracking-tight text-syncro-light md:text-7xl">
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            <a
              href="#servicios"
              className="rounded-full border border-white/15 px-8 py-3.5 font-body text-sm font-medium text-zinc-300 transition hover:border-white/30 hover:text-white"
            >
              Qué hacemos
            </a>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {services.map((s) => (
              <div
                key={s.title}
                className="rounded-2xl border border-white/5 bg-surface-card p-8 transition hover:border-syncro/40 hover:bg-surface-hover"
              >
          ...
          <div className="mt-14 grid gap-px overflow-hidden rounded-2xl border border-white/5 bg-white/5 md:grid-cols-4">
            {steps.map((s) => (
              <div key={s.num} className="bg-surface p-8">
                ...
                <h3 className="mt-3 font-display text-xl font-semibold text-syncro-light">
                  {s.title}
                </h3>
